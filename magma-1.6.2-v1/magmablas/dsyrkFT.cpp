...
//					checksumC2, incC2);
		...
		cublasDgemm(CUBLAS_OP_N, CUBLAS_OP_T, 1, n, m, negone, checksumA1, incA1, A, lda, one, checksumC1, incC1);
		cublasDgemm(CUBLAS_OP_N, CUBLAS_OP_T, 1, n, m, negone, checksumA2, incA2, A, lda, one, checksumC2, incC2);
