#ifndef __EMP_CULA_BLAS_H__
#define __EMP_CULA_BLAS_H__
...
culaStatus culaChemv(char uplo, int n, culaFloatComplex alpha, culaFloatComplex* a, int lda, culaFloatComplex* x, int incx, culaFloatComplex beta, culaFloatComplex* y, int incy);
...
culaStatus culaDsymv(char uplo, int n, culaDouble alpha, culaDouble* a, int lda, culaDouble* x, int incx, culaDouble beta, culaDouble* y, int incy);
...
culaStatus culaSsymv(char uplo, int n, culaFloat alpha, culaFloat* a, int lda, culaFloat* x, int incx, culaFloat beta, culaFloat* y, int incy);
...
culaStatus culaZhemv(char uplo, int n, culaDoubleComplex alpha, culaDoubleComplex* a, int lda, culaDoubleComplex* x, int incx, culaDoubleComplex beta, culaDoubleComplex* y, int incy);
