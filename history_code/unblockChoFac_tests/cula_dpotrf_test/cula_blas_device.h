#ifndef __EMP_CULA_BLAS_DEVICE_H__
#define __EMP_CULA_BLAS_DEVICE_H__
...
culaStatus culaDeviceChemv(char uplo, int n, culaFloatComplex alpha, culaDeviceFloatComplex* a, int lda, culaDeviceFloatComplex* x, int incx, culaFloatComplex beta, culaDeviceFloatComplex* y, int incy);
...
culaStatus culaDeviceDsymv(char uplo, int n, culaDouble alpha, culaDeviceDouble* a, int lda, culaDeviceDouble* x, int incx, culaDouble beta, culaDeviceDouble* y, int incy);
...
culaStatus culaDeviceSsymv(char uplo, int n, culaFloat alpha, culaDeviceFloat* a, int lda, culaDeviceFloat* x, int incx, culaFloat beta, culaDeviceFloat* y, int incy);
...
culaStatus culaDeviceZhemv(char uplo, int n, culaDoubleComplex alpha, culaDeviceDoubleComplex* a, int lda, culaDeviceDoubleComplex* x, int incx, culaDoubleComplex beta, culaDeviceDoubleComplex* y, int incy);
...
#endif  // __EMP_CULA_BLAS_DEVICE_H__
