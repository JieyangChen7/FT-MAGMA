#ifndef __EMP_CULA_DEVICE_H__
#define __EMP_CULA_DEVICE_H__
...
/** 
 * @brief Calculates a pitch that is optimal for CULA when using the device interface
 *
 * @param pitch The optimal pitch for the specified matrix in elements (where *pitch >= rows)
