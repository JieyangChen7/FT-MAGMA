...
void initializeChecksum(double * matrix, int ld, int N, int B, double * vd, int vd_ld, double * v, int v_ld, double * chksumd, int chksumd_ld, double * chksum, int chksum_ld, magma_queue_t * stream);
