/*
 * ACML version 5.3.0 Copyright AMD,NAG 2003-2011
 */
...
extern void classq_(int *n, complex *x, int *incx, float *scale, float *sumsq);
...
extern void cstemr_(char *jobz, char *range, int *n, float *d, float *e, float *vl, float *vu, int *il, int *iu, int *m, float *w, complex *z, int *ldz, int *nzc, int *isuppz, int *tryrac, float *work, int *lwork, int *iwork, int *liwork, int *info, int jobz_len, int range_len);
...
extern void sstemr_(char *jobz, char *range, int *n, float *d, float *e, float *vl, float *vu, int *il, int *iu, int *m, float *w, float *z, int *ldz, int *nzc, int *isuppz, int *tryrac, float *work, int *lwork, int *iwork, int *liwork, int *info, int jobz_len, int range_len);
...
extern void zlassq_(int *n, doublecomplex *x, int *incx, double *scale, double *sumsq);
...
extern void zstemr_(char *jobz, char *range, int *n, double *d, double *e, double *vl, double *vu, int *il, int *iu, int *m, double *w, doublecomplex *z, int *ldz, int *nzc, int *isuppz, int *tryrac, double *work, int *lwork, int *iwork, int *liwork, int *info, int jobz_len, int range_len);
...
extern void cgbequb_(int *m, int *n, int *kl, int *ku, complex *ab, int *ldab, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
extern void cgeequb_(int *m, int *n, complex *a, int *lda, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
extern void cgemqrt_(char *side, char *trans, int *m, int *n, int *k, int *nb, complex *v, int *ldv, complex *t, int *ldt, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
...
extern void cgeqr2p_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cgeqrf_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *lwork, int *info);
extern void cgeqrfp_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *lwork, int *info);
extern void cgeqrt2_(int *m, int *n, complex *a, int *lda, complex *t, int *ldt, int *info);
extern void cgeqrt3_(int *m, int *n, complex *a, int *lda, complex *t, int *ldt, int *info);
extern void cgeqrt_(int *m, int *n, int *nb, complex *a, int *lda, complex *t, int *ldt, complex *work, int *info);
...
extern void cgerfsx_(char *trans, char *equed, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *r, float *c, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int trans_len, int equed_len);
...
extern void cgesvxx_(char *fact, char *trans, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, char *equed, float *r, float *c, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *rpvgrw, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int fact_len, int trans_len, int equed_len);
...
extern void cheequb_(char *uplo, int *n, complex *a, int *lda, float *s, float *scond, float *amax, complex *work, int *info, int uplo_len);
...
extern void chesvxx_(char *fact, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, char *equed, float *s, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *rpvgrw, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int fact_len, int uplo_len, int equed_len);
extern void cheswapr_(char *uplo, int *n, complex *a, int *lda, int *i1, int *i2, int uplo_len);
...
extern void chetri2_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *lwork, int *info, int uplo_len);
extern void chetri2x_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *nb, int *info, int uplo_len);
extern void chetri_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *info, int uplo_len);
extern void chetrs2_(char *uplo, int *n, int *nrhs, complex *a, int *lda, int *ipiv, complex *b, int *ldb, complex *work, int *info, int uplo_len);
extern void chetrs_(char *uplo, int *n, int *nrhs, complex *a, int *lda, int *ipiv, complex *b, int *ldb, int *info, int uplo_len);
extern void chfrk_(char *transr, char *uplo, char *trans, int *n, int *k, float *alpha, complex *a, int *lda, float *beta, complex *c, int transr_len, int uplo_len, int trans_len);
...
extern void chla_transtype_(char *ret_val, int ret_val_len, int *trans);
...
extern void cla_gbamv_(int *trans, int *m, int *n, int *kl, int *ku, float *alpha, complex *ab, int *ldab, complex *x, int *incx, float *beta, float *y, int *incy);
extern float cla_gbrcond_c_(char *trans, int *n, int *kl, int *ku, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int trans_len);
extern float cla_gbrcond_x_(char *trans, int *n, int *kl, int *ku, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, complex *x, int *info, complex *work, float *rwork, int trans_len);
extern void cla_gbrfsx_extended_(int *prec_type, int *trans_type, int *n, int *kl, int *ku, int *nrhs, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *err_bnds_norm, float *err_bnds_comp, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info);
extern float cla_gbrpvgrw_(int *n, int *kl, int *ku, int *ncols, complex *ab, int *ldab, complex *afb, int *ldafb);
extern void cla_geamv_(int *trans, int *m, int *n, float *alpha, complex *a, int *lda, complex *x, int *incx, float *beta, float *y, int *incy);
extern float cla_gercond_c_(char *trans, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int trans_len);
extern float cla_gercond_x_(char *trans, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int trans_len);
extern void cla_gerfsx_extended_(int *prec_type, int *trans_type, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *errs_n, float *errs_c, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info);
extern float cla_gerpvgrw_(int *n, int *ncols, complex *a, int *lda, complex *af, int *ldaf);
extern void cla_heamv_(int *uplo, int *n, float *alpha, complex *a, int *lda, complex *x, int *incx, float *beta, float *y, int *incy);
extern float cla_hercond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern float cla_hercond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int uplo_len);
extern void cla_herfsx_extended_(int *prec_type, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *err_bnds_norm, float *err_bnds_comp, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info, int uplo_len);
extern float cla_herpvgrw_(char *uplo, int *n, int *info, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *work, int uplo_len);
extern void cla_lin_berr_(int *n, int *nz, int *nrhs, complex *res, float *ayb, float *berr);
extern float cla_porcond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern float cla_porcond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, complex *x, int *info, complex *work, float *rwork, int uplo_len);
extern void cla_porfsx_extended_(int *prec_type, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *err_bnds_norm, float *err_bnds_comp, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info, int uplo_len);
extern float cla_porpvgrw_(char *uplo, int *ncols, complex *a, int *lda, complex *af, int *ldaf, float *work, int uplo_len);
extern void cla_syamv_(int *uplo, int *n, float *alpha, complex *a, int *lda, complex *x, int *incx, float *beta, float *y, int *incy);
extern float cla_syrcond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern float cla_syrcond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int uplo_len);
extern void cla_syrfsx_extended_(int *prec_type, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *err_bnds_norm, float *err_bnds_comp, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info, int uplo_len);
extern float cla_syrpvgrw_(char *uplo, int *n, int *info, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *work, int uplo_len);
extern void cla_wwaddw_(int *n, complex *x, complex *y, complex *w);
extern float clanhf_(char *norm, char *transr, char *uplo, int *n, complex *a, float *work, int norm_len, int transr_len, int uplo_len);
extern void clapmr_(int *forwrd, int *m, int *n, complex *x, int *ldx, int *k);
extern void clarfgp_(int *n, complex *alpha, complex *x, int *incx, complex *tau);
extern void clarscl2_(int *m, int *n, float *d, complex *x, int *ldx);
extern void clascl2_(int *m, int *n, float *d, complex *x, int *ldx);
...
extern void cpftrf_(char *transr, char *uplo, int *n, complex *a, int *info, int transr_len, int uplo_len);
extern void cpftri_(char *transr, char *uplo, int *n, complex *a, int *info, int transr_len, int uplo_len);
extern void cpftrs_(char *transr, char *uplo, int *n, int *nrhs, complex *a, complex *b, int *ldb, int *info, int transr_len, int uplo_len);
...
extern void cpoequb_(int *n, complex *a, int *lda, float *s, float *scond, float *amax, int *info);
...
extern void cporfsx_(char *uplo, char *equed, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, float *s, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int uplo_len, int equed_len);
...
extern void cposvxx_(char *fact, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, char *equed, float *s, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *rpvgrw, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int fact_len, int uplo_len, int equed_len);
...
extern void cpstf2_(char *uplo, int *n, complex *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info, int uplo_len);
extern void cpstrf_(char *uplo, int *n, complex *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info, int uplo_len);
...
extern void csyconv_(char *uplo, char *way, int *n, complex *a, int *lda, int *ipiv, complex *work, int *info, int uplo_len, int way_len);
extern void csyequb_(char *uplo, int *n, complex *a, int *lda, float *s, float *scond, float *amax, complex *work, int *info, int uplo_len);
...
extern void csyrfsx_(char *uplo, char *equed, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *s, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int uplo_len, int equed_len);
...
extern void csysvxx_(char *fact, char *uplo, int *n, int *nrhs, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, char *equed, float *s, complex *b, int *ldb, complex *x, int *ldx, float *rcond, float *rpvgrw, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, complex *work, float *rwork, int *info, int fact_len, int uplo_len, int equed_len);
extern void csyswapr_(char *uplo, int *n, complex *a, int *i1, int *i2, int uplo_len);
extern void csytrf_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *lwork, int *info, int uplo_len);
extern void csytri2_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *lwork, int *info, int uplo_len);
extern void csytri2x_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *nb, int *info, int uplo_len);
extern void csytri_(char *uplo, int *n, complex *a, int *lda, int *ipiv, complex *work, int *info, int uplo_len);
extern void csytrs2_(char *uplo, int *n, int *nrhs, complex *a, int *lda, int *ipiv, complex *b, int *ldb, complex *work, int *info, int uplo_len);
...
extern void ctfsm_(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, complex *alpha, complex *a, complex *b, int *ldb, int transr_len, int side_len, int uplo_len, int trans_len, int diag_len);
extern void ctftri_(char *transr, char *uplo, char *diag, int *n, complex *a, int *info, int transr_len, int uplo_len, int diag_len);
extern void ctfttp_(char *transr, char *uplo, int *n, complex *arf, complex *ap, int *info, int transr_len, int uplo_len);
extern void ctfttr_(char *transr, char *uplo, int *n, complex *arf, complex *a, int *lda, int *info, int transr_len, int uplo_len);
...
extern void ctpmqrt_(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, complex *v, int *ldv, complex *t, int *ldt, complex *a, int *lda, complex *b, int *ldb, complex *work, int *info, int side_len, int trans_len);
extern void ctpqrt2_(int *m, int *n, int *l, complex *a, int *lda, complex *b, int *ldb, complex *t, int *ldt, int *info);
extern void ctpqrt_(int *m, int *n, int *l, int *nb, complex *a, int *lda, complex *b, int *ldb, complex *t, int *ldt, complex *work, int *info);
extern void ctprfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, complex *v, int *ldv, complex *t, int *ldt, complex *a, int *lda, complex *b, int *ldb, complex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
...
extern void ctpttf_(char *transr, char *uplo, int *n, complex *ap, complex *arf, int *info, int transr_len, int uplo_len);
extern void ctpttr_(char *uplo, int *n, complex *ap, complex *a, int *lda, int *info, int uplo_len);
...
extern void ctrttf_(char *transr, char *uplo, int *n, complex *a, int *lda, complex *arf, int *info, int transr_len, int uplo_len);
extern void ctrttp_(char *uplo, int *n, complex *a, int *lda, complex *ap, int *info, int uplo_len);
...
extern void cunbdb_(char *trans, char *signs, int *m, int *p, int *q, complex *x11, int *ldx11, complex *x12, int *ldx12, complex *x21, int *ldx21, complex *x22, int *ldx22, float *theta, float *phi, complex *taup1, complex *taup2, complex *tauq1, complex *tauq2, complex *work, int *lwork, int *info, int trans_len, int signs_len);
extern void cuncsd_(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, char *signs, int *m, int *p, int *q, complex *x11, int *ldx11, complex *x12, int *ldx12, complex *x21, int *ldx21, complex *x22, int *ldx22, float *theta, complex *u1, int *ldu1, complex *u2, int *ldu2, complex *v1t, int *ldv1t, complex *v2t, int *ldv2t, complex *work, int *lwork, float *rwork, int *lrwork, int *iwork, int *info, int jobu1_len, int jobu2_len, int jobv1t_len, int jobv2t_len, int trans_len, int signs_len);
...
extern void dbbcsd_(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, int *m, int *p, int *q, double *theta, double *phi, double *u1, int *ldu1, double *u2, int *ldu2, double *v1t, int *ldv1t, double *v2t, int *ldv2t, double *b11d, double *b11e, double *b12d, double *b12e, double *b21d, double *b21e, double *b22d, double *b22e, double *work, int *lwork, int *info, int jobu1_len, int jobu2_len, int jobv1t_len, int jobv2t_len, int trans_len);
...
extern void dgejsv_(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, double *a, int *lda, double *sva, double *u, int *ldu, double *v, int *ldv, double *work, int *lwork, int *iwork, int *info, int joba_len, int jobu_len, int jobv_len, int jobr_len, int jobt_len, int jobp_len);
...
extern void dgemqrt_(char *side, char *trans, int *m, int *n, int *k, int *nb, double *v, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *info, int side_len, int trans_len);
...
extern void dgesvj_(char *joba, char *jobu, char *jobv, int *m, int *n, double *a, int *lda, double *sva, int *mv, double *v, int *ldv, double *work, int *lwork, int *info, int joba_len, int jobu_len, int jobv_len);
...
extern void dgsvj0_(char *jobv, int *m, int *n, double *a, int *lda, double *d, double *sva, int *mv, double *v, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info, int jobv_len);
extern void dgsvj1_(char *jobv, int *m, int *n, int *n1, double *a, int *lda, double *d, double *sva, int *mv, double *v, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info, int jobv_len);
...
extern double dla_gbrcond_(char *trans, int *n, int *kl, int *ku, double *ab, int *ldab, double *afb, int *ldafb, int *ipiv, int *cmode, double *c, int *info, double *work, int *iwork, int trans_len);
...
extern double dla_gercond_(char *trans, int *n, double *a, int *lda, double *af, int *ldaf, int *ipiv, int *cmode, double *c, int *info, double *work, int *iwork, int trans_len);
...
extern double dla_porcond_(char *uplo, int *n, double *a, int *lda, double *af, int *ldaf, int *cmode, double *c, int *info, double *work, int *iwork, int uplo_len);
...
extern double dla_porpvgrw_(char *uplo, int *ncols, double *a, int *lda, double *af, int *ldaf, double *work, int uplo_len);
extern void dla_syamv_(int *uplo, int *n, double *alpha, double *a, int *lda, double *x, int *incx, double *beta, double *y, int *incy);
extern double dla_syrcond_(char *uplo, int *n, double *a, int *lda, double *af, int *ldaf, int *ipiv, int *cmode, double *c, int *info, double *work, int *iwork, int uplo_len);
...
extern double dla_syrpvgrw_(char *uplo, int *n, int *info, double *a, int *lda, double *af, int *ldaf, int *ipiv, double *work, int uplo_len);
extern void dla_wwaddw_(int *n, double *x, double *y, double *w);
extern double dlamch_(char *cmach, int cmach_len);
extern double dlansf_(char *norm, char *transr, char *uplo, int *n, double *a, double *work, int norm_len, int transr_len, int uplo_len);
...
extern void dlarft_(char *direct, char *storev, int *n, int *k, double *v, int *ldv, double *tau, double *t, int *ldt, int direct_len, int storev_len);
...
extern void dlasrt_(char *id, int *n, double *d, int *info, int id_len);
extern void dlassq_(int *n, double *x, int *incx, double *scale, double *sumsq);
extern void dlat2s_(char *uplo, int *n, double *a, int *lda, float *sa, int *ldsa, int *info, int uplo_len);
...
extern void dorbdb_(char *trans, char *signs, int *m, int *p, int *q, double *x11, int *ldx11, double *x12, int *ldx12, double *x21, int *ldx21, double *x22, int *ldx22, double *theta, double *phi, double *taup1, double *taup2, double *tauq1, double *tauq2, double *work, int *lwork, int *info, int trans_len, int signs_len);
...
extern void dpftrf_(char *transr, char *uplo, int *n, double *a, int *info, int transr_len, int uplo_len);
extern void dpftri_(char *transr, char *uplo, int *n, double *a, int *info, int transr_len, int uplo_len);
extern void dpftrs_(char *transr, char *uplo, int *n, int *nrhs, double *a, double *b, int *ldb, int *info, int transr_len, int uplo_len);
...
extern void dpstf2_(char *uplo, int *n, double *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info, int uplo_len);
extern void dpstrf_(char *uplo, int *n, double *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info, int uplo_len);
...
extern void dsfrk_(char *transr, char *uplo, char *trans, int *n, int *k, double *alpha, double *a, int *lda, double *beta, double *c, int transr_len, int uplo_len, int trans_len);
...
extern void dsposv_(char *uplo, int *n, int *nrhs, double *a, int *lda, double *b, int *ldb, double *x, int *ldx, double *work, float *swork, int *iter, int *info, int uplo_len);
...
extern void dstemr_(char *jobz, char *range, int *n, double *d, double *e, double *vl, double *vu, int *il, int *iu, int *m, double *w, double *z, int *ldz, int *nzc, int *isuppz, int *tryrac, double *work, int *lwork, int *iwork, int *liwork, int *info, int jobz_len, int range_len);
...
extern void dsyswapr_(char *uplo, int *n, double *a, int *i1, int *i2, int uplo_len);
...
extern void dsytri2_(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *lwork, int *info, int uplo_len);
extern void dsytri2x_(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *nb, int *info, int uplo_len);
extern void dsytri_(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *info, int uplo_len);
extern void dsytrs2_(char *uplo, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, double *work, int *info, int uplo_len);
...
extern void dtfsm_(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, double *alpha, double *a, double *b, int *ldb, int transr_len, int side_len, int uplo_len, int trans_len, int diag_len);
extern void dtftri_(char *transr, char *uplo, char *diag, int *n, double *a, int *info, int transr_len, int uplo_len, int diag_len);
extern void dtfttp_(char *transr, char *uplo, int *n, double *arf, double *ap, int *info, int transr_len, int uplo_len);
extern void dtfttr_(char *transr, char *uplo, int *n, double *arf, double *a, int *lda, int *info, int transr_len, int uplo_len);
...
extern void dtpmqrt_(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, double *v, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *info, int side_len, int trans_len);
...
extern void dtprfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, double *v, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
...
extern void dtpttf_(char *transr, char *uplo, int *n, double *ap, double *arf, int *info, int transr_len, int uplo_len);
extern void dtpttr_(char *uplo, int *n, double *ap, double *a, int *lda, int *info, int uplo_len);
...
extern void dtrttf_(char *transr, char *uplo, int *n, double *a, int *lda, double *arf, int *info, int transr_len, int uplo_len);
extern void dtrttp_(char *uplo, int *n, double *a, int *lda, double *ap, int *info, int uplo_len);
...
extern int ilaclc_(int *m, int *n, complex *a, int *lda);
extern int ilaclr_(int *m, int *n, complex *a, int *lda);
extern int iladiag_(char *diag, int diag_len);
extern int iladlc_(int *m, int *n, double *a, int *lda);
extern int iladlr_(int *m, int *n, double *a, int *lda);
extern int ilaprec_(char *prec, int prec_len);
extern int ilaslc_(int *m, int *n, float *a, int *lda);
extern int ilaslr_(int *m, int *n, float *a, int *lda);
extern int ilatrans_(char *trans, int trans_len);
extern int ilauplo_(char *uplo, int uplo_len);
extern int ilazlc_(int *m, int *n, doublecomplex *a, int *lda);
extern int ilazlr_(int *m, int *n, doublecomplex *a, int *lda);
...
extern void sgejsv_(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, float *a, int *lda, float *sva, float *u, int *ldu, float *v, int *ldv, float *work, int *lwork, int *iwork, int *info, int joba_len, int jobu_len, int jobv_len, int jobr_len, int jobt_len, int jobp_len);
...
extern void sgemqrt_(char *side, char *trans, int *m, int *n, int *k, int *nb, float *v, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *info, int side_len, int trans_len);
...
extern void sgesvj_(char *joba, char *jobu, char *jobv, int *m, int *n, float *a, int *lda, float *sva, int *mv, float *v, int *ldv, float *work, int *lwork, int *info, int joba_len, int jobu_len, int jobv_len);
...
extern void sgsvj0_(char *jobv, int *m, int *n, float *a, int *lda, float *d, float *sva, int *mv, float *v, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info, int jobv_len);
extern void sgsvj1_(char *jobv, int *m, int *n, int *n1, float *a, int *lda, float *d, float *sva, int *mv, float *v, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info, int jobv_len);
...
extern double sla_gbrcond_(char *trans, int *n, int *kl, int *ku, float *ab, int *ldab, float *afb, int *ldafb, int *ipiv, int *cmode, float *c, int *info, float *work, int *iwork, int trans_len);
...
extern double sla_gercond_(char *trans, int *n, float *a, int *lda, float *af, int *ldaf, int *ipiv, int *cmode, float *c, int *info, float *work, int *iwork, int trans_len);
...
extern double sla_porcond_(char *uplo, int *n, float *a, int *lda, float *af, int *ldaf, int *cmode, float *c, int *info, float *work, int *iwork, int uplo_len);
...
extern double sla_porpvgrw_(char *uplo, int *ncols, float *a, int *lda, float *af, int *ldaf, float *work, int uplo_len);
extern void sla_syamv_(int *uplo, int *n, float *alpha, float *a, int *lda, float *x, int *incx, float *beta, float *y, int *incy);
extern double sla_syrcond_(char *uplo, int *n, float *a, int *lda, float *af, int *ldaf, int *ipiv, int *cmode, float *c, int *info, float *work, int *iwork, int uplo_len);
...
extern double sla_syrpvgrw_(char *uplo, int *n, int *info, float *a, int *lda, float *af, int *ldaf, int *ipiv, float *work, int uplo_len);
extern void sla_wwaddw_(int *n, float *x, float *y, float *w);
extern float slamch_(char *cmach, int cmach_len);
extern float slansf_(char *norm, char *transr, char *uplo, int *n, float *a, float *work, int norm_len, int transr_len, int uplo_len);
...
extern void slarft_(char *direct, char *storev, int *n, int *k, float *v, int *ldv, float *tau, float *t, int *ldt, int direct_len, int storev_len);
...
extern void slasrt_(char *id, int *n, float *d, int *info, int id_len);
...
extern void sorbdb_(char *trans, char *signs, int *m, int *p, int *q, float *x11, int *ldx11, float *x12, int *ldx12, float *x21, int *ldx21, float *x22, int *ldx22, float *theta, float *phi, float *taup1, float *taup2, float *tauq1, float *tauq2, float *work, int *lwork, int *info, int trans_len, int signs_len);
...
extern void spftrf_(char *transr, char *uplo, int *n, float *a, int *info, int transr_len, int uplo_len);
extern void spftri_(char *transr, char *uplo, int *n, float *a, int *info, int transr_len, int uplo_len);
extern void spftrs_(char *transr, char *uplo, int *n, int *nrhs, float *a, float *b, int *ldb, int *info, int transr_len, int uplo_len);
...
extern void sporfsx_(char *uplo, char *equed, int *n, int *nrhs, float *a, int *lda, float *af, int *ldaf, float *s, float *b, int *ldb, float *x, int *ldx, float *rcond, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, float *work, int *iwork, int *info, int uplo_len, int equed_len);
...
extern void spstf2_(char *uplo, int *n, float *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info, int uplo_len);
extern void spstrf_(char *uplo, int *n, float *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info, int uplo_len);
...
extern void ssfrk_(char *transr, char *uplo, char *trans, int *n, int *k, float *alpha, float *a, int *lda, float *beta, float *c, int transr_len, int uplo_len, int trans_len);
...
extern void ssyconv_(char *uplo, char *way, int *n, float *a, int *lda, int *ipiv, float *work, int *info, int uplo_len, int way_len);
extern void ssyequb_(char *uplo, int *n, float *a, int *lda, float *s, float *scond, float *amax, float *work, int *info, int uplo_len);
...
extern void ssyrfsx_(char *uplo, char *equed, int *n, int *nrhs, float *a, int *lda, float *af, int *ldaf, int *ipiv, float *s, float *b, int *ldb, float *x, int *ldx, float *rcond, float *berr, int *n_err_bnds, float *err_bnds_norm, float *err_bnds_comp, int *nparams, float *params, float *work, int *iwork, int *info, int uplo_len, int equed_len);
...
extern void ssyswapr_(char *uplo, int *n, float *a, int *i1, int *i2, int uplo_len);
...
extern void ssytri2_(char *uplo, int *n, float *a, int *lda, int *ipiv, float *work, int *lwork, int *info, int uplo_len);
extern void ssytri2x_(char *uplo, int *n, float *a, int *lda, int *ipiv, float *work, int *nb, int *info, int uplo_len);
extern void ssytri_(char *uplo, int *n, float *a, int *lda, int *ipiv, float *work, int *info, int uplo_len);
extern void ssytrs2_(char *uplo, int *n, int *nrhs, float *a, int *lda, int *ipiv, float *b, int *ldb, float *work, int *info, int uplo_len);
...
extern void stfsm_(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, float *alpha, float *a, float *b, int *ldb, int transr_len, int side_len, int uplo_len, int trans_len, int diag_len);
extern void stftri_(char *transr, char *uplo, char *diag, int *n, float *a, int *info, int transr_len, int uplo_len, int diag_len);
extern void stfttp_(char *transr, char *uplo, int *n, float *arf, float *ap, int *info, int transr_len, int uplo_len);
extern void stfttr_(char *transr, char *uplo, int *n, float *arf, float *a, int *lda, int *info, int transr_len, int uplo_len);
...
extern void stpmqrt_(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, float *v, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *info, int side_len, int trans_len);
...
extern void stprfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, float *v, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
...
extern void stpttf_(char *transr, char *uplo, int *n, float *ap, float *arf, int *info, int transr_len, int uplo_len);
extern void stpttr_(char *uplo, int *n, float *ap, float *a, int *lda, int *info, int uplo_len);
...
extern void strttf_(char *transr, char *uplo, int *n, float *a, int *lda, float *arf, int *info, int transr_len, int uplo_len);
extern void strttp_(char *uplo, int *n, float *a, int *lda, float *ap, int *info, int uplo_len);
...
extern void zcgesv_(int *n, int *nrhs, doublecomplex *a, int *lda, int *ipiv, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, doublecomplex *work, complex *swork, int *iter, int *info);
extern void zcposv_(char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, doublecomplex *work, complex *swork, double *rwork, int *iter, int *info, int uplo_len);
...
extern void zgbequb_(int *m, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
extern void zgbrfsx_(char *trans, char *equed, int *n, int *kl, int *ku, int *nrhs, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, int *ipiv, double *r, double *c, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int trans_len, int equed_len);
...
extern void zgbsvxx_(char *fact, char *trans, int *n, int *kl, int *ku, int *nrhs, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, int *ipiv, char *equed, double *r, double *c, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *rpvgrw, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int fact_len, int trans_len, int equed_len);
...
extern void zgeequb_(int *m, int *n, doublecomplex *a, int *lda, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
extern void zgemqrt_(char *side, char *trans, int *m, int *n, int *k, int *nb, doublecomplex *v, int *ldv, doublecomplex *t, int *ldt, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
...
extern void zgeqr2p_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgeqrf_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *lwork, int *info);
extern void zgeqrfp_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *lwork, int *info);
extern void zgeqrt2_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *t, int *ldt, int *info);
extern void zgeqrt3_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *t, int *ldt, int *info);
extern void zgeqrt_(int *m, int *n, int *nb, doublecomplex *a, int *lda, doublecomplex *t, int *ldt, doublecomplex *work, int *info);
...
extern void zgesvxx_(char *fact, char *trans, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, char *equed, double *r, double *c, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *rpvgrw, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int fact_len, int trans_len, int equed_len);
...
extern void zheequb_(char *uplo, int *n, doublecomplex *a, int *lda, double *s, double *scond, double *amax, doublecomplex *work, int *info, int uplo_len);
...
extern void zherfsx_(char *uplo, char *equed, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int uplo_len, int equed_len);
...
extern void zhesvxx_(char *fact, char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, char *equed, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *rpvgrw, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int fact_len, int uplo_len, int equed_len);
extern void zheswapr_(char *uplo, int *n, doublecomplex *a, int *lda, int *i1, int *i2, int uplo_len);
...
extern void zhetri2_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *lwork, int *info, int uplo_len);
extern void zhetri2x_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *nb, int *info, int uplo_len);
extern void zhetri_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *info, int uplo_len);
extern void zhetrs2_(char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, int *ipiv, doublecomplex *b, int *ldb, doublecomplex *work, int *info, int uplo_len);
...
extern void zhfrk_(char *transr, char *uplo, char *trans, int *n, int *k, double *alpha, doublecomplex *a, int *lda, double *beta, doublecomplex *c, int transr_len, int uplo_len, int trans_len);
...
extern void zla_gbamv_(int *trans, int *m, int *n, int *kl, int *ku, double *alpha, doublecomplex *ab, int *ldab, doublecomplex *x, int *incx, double *beta, double *y, int *incy);
extern double zla_gbrcond_c_(char *trans, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, int *ipiv, double *c, int *capply, int *info, doublecomplex *work, double *rwork, int trans_len);
extern double zla_gbrcond_x_(char *trans, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, int *ipiv, doublecomplex *x, int *info, doublecomplex *work, double *rwork, int trans_len);
extern void zla_gbrfsx_extended_(int *prec_type, int *trans_type, int *n, int *kl, int *ku, int *nrhs, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, int *ipiv, int *colequ, double *c, doublecomplex *b, int *ldb, doublecomplex *y, int *ldy, double *berr_out, int *n_norms, double *err_bnds_norm, double *err_bnds_comp, doublecomplex *res, double *ayb, doublecomplex *dy, doublecomplex *y_tail, double *rcond, int *ithresh, double *rthresh, double *dz_ub, int *ignore_cwise, int *info);
extern double zla_gbrpvgrw_(int *n, int *kl, int *ku, int *ncols, doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb);
extern void zla_geamv_(int *trans, int *m, int *n, double *alpha, doublecomplex *a, int *lda, doublecomplex *x, int *incx, double *beta, double *y, int *incy);
extern double zla_gercond_c_(char *trans, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *c, int *capply, int *info, doublecomplex *work, double *rwork, int trans_len);
extern double zla_gercond_x_(char *trans, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, doublecomplex *x, int *info, doublecomplex *work, double *rwork, int trans_len);
extern void zla_gerfsx_extended_(int *prec_type, int *trans_type, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, int *colequ, double *c, doublecomplex *b, int *ldb, doublecomplex *y, int *ldy, double *berr_out, int *n_norms, double *errs_n, double *errs_c, doublecomplex *res, double *ayb, doublecomplex *dy, doublecomplex *y_tail, double *rcond, int *ithresh, double *rthresh, double *dz_ub, int *ignore_cwise, int *info);
extern double zla_gerpvgrw_(int *n, int *ncols, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf);
extern void zla_heamv_(int *uplo, int *n, double *alpha, doublecomplex *a, int *lda, doublecomplex *x, int *incx, double *beta, double *y, int *incy);
extern double zla_hercond_c_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *c, int *capply, int *info, doublecomplex *work, double *rwork, int uplo_len);
extern double zla_hercond_x_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, doublecomplex *x, int *info, doublecomplex *work, double *rwork, int uplo_len);
extern void zla_herfsx_extended_(int *prec_type, char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, int *colequ, double *c, doublecomplex *b, int *ldb, doublecomplex *y, int *ldy, double *berr_out, int *n_norms, double *err_bnds_norm, double *err_bnds_comp, doublecomplex *res, double *ayb, doublecomplex *dy, doublecomplex *y_tail, double *rcond, int *ithresh, double *rthresh, double *dz_ub, int *ignore_cwise, int *info, int uplo_len);
extern double zla_herpvgrw_(char *uplo, int *n, int *info, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *work, int uplo_len);
extern void zla_lin_berr_(int *n, int *nz, int *nrhs, doublecomplex *res, double *ayb, double *berr);
extern double zla_porcond_c_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, double *c, int *capply, int *info, doublecomplex *work, double *rwork, int uplo_len);
extern double zla_porcond_x_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, doublecomplex *x, int *info, doublecomplex *work, double *rwork, int uplo_len);
extern void zla_porfsx_extended_(int *prec_type, char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *colequ, double *c, doublecomplex *b, int *ldb, doublecomplex *y, int *ldy, double *berr_out, int *n_norms, double *err_bnds_norm, double *err_bnds_comp, doublecomplex *res, double *ayb, doublecomplex *dy, doublecomplex *y_tail, double *rcond, int *ithresh, double *rthresh, double *dz_ub, int *ignore_cwise, int *info, int uplo_len);
extern double zla_porpvgrw_(char *uplo, int *ncols, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, double *work, int uplo_len);
extern void zla_syamv_(int *uplo, int *n, double *alpha, doublecomplex *a, int *lda, doublecomplex *x, int *incx, double *beta, double *y, int *incy);
extern double zla_syrcond_c_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *c, int *capply, int *info, doublecomplex *work, double *rwork, int uplo_len);
extern double zla_syrcond_x_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, doublecomplex *x, int *info, doublecomplex *work, double *rwork, int uplo_len);
...
extern double zla_syrpvgrw_(char *uplo, int *n, int *info, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *work, int uplo_len);
extern void zla_wwaddw_(int *n, doublecomplex *x, doublecomplex *y, doublecomplex *w);
extern double zlanhf_(char *norm, char *transr, char *uplo, int *n, doublecomplex *a, double *work, int norm_len, int transr_len, int uplo_len);
extern void zlapmr_(int *forwrd, int *m, int *n, doublecomplex *x, int *ldx, int *k);
extern void zlarfgp_(int *n, doublecomplex *alpha, doublecomplex *x, int *incx, doublecomplex *tau);
extern void zlarscl2_(int *m, int *n, double *d, doublecomplex *x, int *ldx);
extern void zlascl2_(int *m, int *n, double *d, doublecomplex *x, int *ldx);
extern void zlat2c_(char *uplo, int *n, doublecomplex *a, int *lda, complex *sa, int *ldsa, int *info, int uplo_len);
...
extern void zpftrf_(char *transr, char *uplo, int *n, doublecomplex *a, int *info, int transr_len, int uplo_len);
extern void zpftri_(char *transr, char *uplo, int *n, doublecomplex *a, int *info, int transr_len, int uplo_len);
extern void zpftrs_(char *transr, char *uplo, int *n, int *nrhs, doublecomplex *a, doublecomplex *b, int *ldb, int *info, int transr_len, int uplo_len);
...
extern void zpoequb_(int *n, doublecomplex *a, int *lda, double *s, double *scond, double *amax, int *info);
...
extern void zporfsx_(char *uplo, char *equed, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int uplo_len, int equed_len);
...
extern void zposvxx_(char *fact, char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, char *equed, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *rpvgrw, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int fact_len, int uplo_len, int equed_len);
...
extern void zpstf2_(char *uplo, int *n, doublecomplex *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info, int uplo_len);
extern void zpstrf_(char *uplo, int *n, doublecomplex *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info, int uplo_len);
...
extern void zsyconv_(char *uplo, char *way, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *info, int uplo_len, int way_len);
extern void zsyequb_(char *uplo, int *n, doublecomplex *a, int *lda, double *s, double *scond, double *amax, doublecomplex *work, int *info, int uplo_len);
...
extern void zsyrfsx_(char *uplo, char *equed, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int uplo_len, int equed_len);
...
extern void zsysvxx_(char *fact, char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf, int *ipiv, char *equed, double *s, doublecomplex *b, int *ldb, doublecomplex *x, int *ldx, double *rcond, double *rpvgrw, double *berr, int *n_err_bnds, double *err_bnds_norm, double *err_bnds_comp, int *nparams, double *params, doublecomplex *work, double *rwork, int *info, int fact_len, int uplo_len, int equed_len);
extern void zsyswapr_(char *uplo, int *n, doublecomplex *a, int *i1, int *i2, int uplo_len);
extern void zsytrf_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *lwork, int *info, int uplo_len);
extern void zsytri2_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *lwork, int *info, int uplo_len);
extern void zsytri2x_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *nb, int *info, int uplo_len);
extern void zsytri_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, doublecomplex *work, int *info, int uplo_len);
extern void zsytrs2_(char *uplo, int *n, int *nrhs, doublecomplex *a, int *lda, int *ipiv, doublecomplex *b, int *ldb, doublecomplex *work, int *info, int uplo_len);
...
extern void ztfsm_(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, doublecomplex *alpha, doublecomplex *a, doublecomplex *b, int *ldb, int transr_len, int side_len, int uplo_len, int trans_len, int diag_len);
extern void ztftri_(char *transr, char *uplo, char *diag, int *n, doublecomplex *a, int *info, int transr_len, int uplo_len, int diag_len);
extern void ztfttp_(char *transr, char *uplo, int *n, doublecomplex *arf, doublecomplex *ap, int *info, int transr_len, int uplo_len);
extern void ztfttr_(char *transr, char *uplo, int *n, doublecomplex *arf, doublecomplex *a, int *lda, int *info, int transr_len, int uplo_len);
...
extern void ztpmqrt_(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, doublecomplex *v, int *ldv, doublecomplex *t, int *ldt, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *work, int *info, int side_len, int trans_len);
extern void ztpqrt2_(int *m, int *n, int *l, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *t, int *ldt, int *info);
extern void ztpqrt_(int *m, int *n, int *l, int *nb, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *t, int *ldt, doublecomplex *work, int *info);
extern void ztprfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, doublecomplex *v, int *ldv, doublecomplex *t, int *ldt, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
...
extern void ztpttf_(char *transr, char *uplo, int *n, doublecomplex *ap, doublecomplex *arf, int *info, int transr_len, int uplo_len);
extern void ztpttr_(char *uplo, int *n, doublecomplex *ap, doublecomplex *a, int *lda, int *info, int uplo_len);
...
extern void ztrttf_(char *transr, char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *arf, int *info, int transr_len, int uplo_len);
extern void ztrttp_(char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *ap, int *info, int uplo_len);
...
extern void zunbdb_(char *trans, char *signs, int *m, int *p, int *q, doublecomplex *x11, int *ldx11, doublecomplex *x12, int *ldx12, doublecomplex *x21, int *ldx21, doublecomplex *x22, int *ldx22, double *theta, double *phi, doublecomplex *taup1, doublecomplex *taup2, doublecomplex *tauq1, doublecomplex *tauq2, doublecomplex *work, int *lwork, int *info, int trans_len, int signs_len);
...
extern void cgelq2_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cgeql2_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cgeqr2_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cgerq2_(int *m, int *n, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cgesc2_(int *n, complex *a, int *lda, complex *rhs, int *ipiv, int *jpiv, float *scale);
extern void cgetc2_(int *n, complex *a, int *lda, int *ipiv, int *jpiv, int *info);
extern void cgetf2_(int *m, int *n, complex *a, int *lda, int *ipiv, int *info);
extern void cgtts2_(int *itrans, int *n, int *nrhs, complex *dl, complex *d, complex *du, complex *du2, int *ipiv, complex *b, int *ldb);
extern void chegs2_(int *itype, char *uplo, int *n, complex *a, int *lda, complex *b, int *ldb, int *info, int uplo_len);
extern void chetd2_(char *uplo, int *n, complex *a, int *lda, float *d, float *e, complex *tau, int *info, int uplo_len);
extern void chetf2_(char *uplo, int *n, complex *a, int *lda, int *ipiv, int *info, int uplo_len);
extern void clabrd_(int *m, int *n, int *nb, complex *a, int *lda, float *d, float *e, complex *tauq, complex *taup, complex *x, int *ldx, complex *y, int *ldy);
extern void clacgv_(int *n, complex *x, int *incx);
extern void clacn2_(int *n, complex *v, complex *x, float *est, int *kase, int *isave);
extern void clacon_(int *n, complex *v, complex *x, float *est, int *kase);
extern void clacp2_(char *uplo, int *m, int *n, float *a, int *lda, complex *b, int *ldb, int uplo_len);
extern void clacpy_(char *uplo, int *m, int *n, complex *a, int *lda, complex *b, int *ldb, int uplo_len);
extern void clacrm_(int *m, int *n, complex *a, int *lda, float *b, int *ldb, complex *c, int *ldc, float *rwork);
extern void clacrt_(int *n, complex *cx, int *incx, complex *cy, int *incy, complex *c, complex *s);
extern complex cladiv_(complex *ret_val, complex *x, complex *y);
extern void claed0_(int *qsiz, int *n, float *d, float *e, complex *q, int *ldq, complex *qstore, int *ldqs, float *rwork, int *iwork, int *info);
extern void claed7_(int *n, int *cutpnt, int *qsiz, int *tlvls, int *curlvl, int *curpbm, float *d, complex *q, int *ldq, float *rho, int *indxq, float *qstore, int *qptr, int *prmptr, int *perm, int *givptr, int *givcol, float *givnum, complex *work, float *rwork, int *iwork, int *info);
extern void claed8_(int *k, int *n, int *qsiz, complex *q, int *ldq, float *d, float *rho, int *cutpnt, float *z, float *dlamda, complex *q2, int *ldq2, float *w, int *indxp, int *indx, int *indxq, int *perm, int *givptr, int *givcol, float *givnum, int *info);
extern void claein_(int *rightv, int *noinit, int *n, complex *h, int *ldh, complex *w, complex *v, complex *b, int *ldb, float *rwork, float *eps3, float *smlnum, int *info);
...
extern void clag2z_(int *m, int *n, complex *sa, int *ldsa, doublecomplex *a, int *lda, int *info);
extern void clags2_(int *upper, float *a1, complex *a2, float *a3, float *b1, complex *b2, float *b3, float *csu, complex *snu, float *csv, complex *snv, float *csq, complex *snq);
extern void clagtm_(char *trans, int *n, int *nrhs, float *alpha, complex *dl, complex *d, complex *du, complex *x, int *ldx, float *beta, complex *b, int *ldb, int trans_len);
extern void clahef_(char *uplo, int *n, int *nb, int *kb, complex *a, int *lda, int *ipiv, complex *w, int *ldw, int *info, int uplo_len);
extern void clahqr_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, complex *h, int *ldh, complex *w, int *iloz, int *ihiz, complex *z, int *ldz, int *info);
extern void clahr2_(int *n, int *k, int *nb, complex *a, int *lda, complex *tau, complex *t, int *ldt, complex *y, int *ldy);
extern void clahrd_(int *n, int *k, int *nb, complex *a, int *lda, complex *tau, complex *t, int *ldt, complex *y, int *ldy);
extern void claic1_(int *job, int *j, complex *x, float *sest, complex *w, complex *gamma, float *sestpr, complex *s, complex *c);
extern void clals0_(int *icompq, int *nl, int *nr, int *sqre, int *nrhs, complex *b, int *ldb, complex *bx, int *ldbx, int *perm, int *givptr, int *givcol, int *ldgcol, float *givnum, int *ldgnum, float *poles, float *difl, float *difr, float *z, int *k, float *c, float *s, float *rwork, int *info);
extern void clalsa_(int *icompq, int *smlsiz, int *n, int *nrhs, complex *b, int *ldb, complex *bx, int *ldbx, float *u, int *ldu, float *vt, int *k, float *difl, float *difr, float *z, float *poles, int *givptr, int *givcol, int *ldgcol, int *perm, float *givnum, float *c, float *s, float *rwork, int *iwork, int *info);
extern void clalsd_(char *uplo, int *smlsiz, int *n, int *nrhs, float *d, float *e, complex *b, int *ldb, float *rcond, int *rank, complex *work, float *rwork, int *iwork, int *info, int uplo_len);
extern float clangb_(char *norm, int *n, int *kl, int *ku, complex *ab, int *ldab, float *work, int norm_len);
extern float clange_(char *norm, int *m, int *n, complex *a, int *lda, float *work, int norm_len);
extern float clangt_(char *norm, int *n, complex *dl, complex *d, complex *du, int norm_len);
extern float clanhb_(char *norm, char *uplo, int *n, int *k, complex *ab, int *ldab, float *work, int norm_len, int uplo_len);
extern float clanhe_(char *norm, char *uplo, int *n, complex *a, int *lda, float *work, int norm_len, int uplo_len);
extern float clanhp_(char *norm, char *uplo, int *n, complex *ap, float *work, int norm_len, int uplo_len);
extern float clanhs_(char *norm, int *n, complex *a, int *lda, float *work, int norm_len);
extern float clanht_(char *norm, int *n, float *d, complex *e, int norm_len);
extern float clansb_(char *norm, char *uplo, int *n, int *k, complex *ab, int *ldab, float *work, int norm_len, int uplo_len);
extern float clansp_(char *norm, char *uplo, int *n, complex *ap, float *work, int norm_len, int uplo_len);
extern float clansy_(char *norm, char *uplo, int *n, complex *a, int *lda, float *work, int norm_len, int uplo_len);
extern float clantb_(char *norm, char *uplo, char *diag, int *n, int *k, complex *ab, int *ldab, float *work, int norm_len, int uplo_len, int diag_len);
extern float clantp_(char *norm, char *uplo, char *diag, int *n, complex *ap, float *work, int norm_len, int uplo_len, int diag_len);
extern float clantr_(char *norm, char *uplo, char *diag, int *m, int *n, complex *a, int *lda, float *work, int norm_len, int uplo_len, int diag_len);
extern void clapll_(int *n, complex *x, int *incx, complex *y, int *incy, float *ssmin);
extern void clapmt_(int *forwrd, int *m, int *n, complex *x, int *ldx, int *k);
extern void claqgb_(int *m, int *n, int *kl, int *ku, complex *ab, int *ldab, float *r, float *c, float *rowcnd, float *colcnd, float *amax, char *equed, int equed_len);
extern void claqge_(int *m, int *n, complex *a, int *lda, float *r, float *c, float *rowcnd, float *colcnd, float *amax, char *equed, int equed_len);
extern void claqhb_(char *uplo, int *n, int *kd, complex *ab, int *ldab, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void claqhe_(char *uplo, int *n, complex *a, int *lda, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void claqhp_(char *uplo, int *n, complex *ap, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void claqp2_(int *m, int *n, int *offset, complex *a, int *lda, int *jpvt, complex *tau, float *vn1, float *vn2, complex *work);
extern void claqps_(int *m, int *n, int *offset, int *nb, int *kb, complex *a, int *lda, int *jpvt, complex *tau, float *vn1, float *vn2, complex *auxv, complex *f, int *ldf);
extern void claqr0_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, complex *h, int *ldh, complex *w, int *iloz, int *ihiz, complex *z, int *ldz, complex *work, int *lwork, int *info);
extern void claqr1_(int *n, complex *h, int *ldh, complex *s1, complex *s2, complex *v);
extern void claqr2_(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, complex *h, int *ldh, int *iloz, int *ihiz, complex *z, int *ldz, int *ns, int *nd, complex *sh, complex *v, int *ldv, int *nh, complex *t, int *ldt, int *nv, complex *wv, int *ldwv, complex *work, int *lwork);
extern void claqr3_(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, complex *h, int *ldh, int *iloz, int *ihiz, complex *z, int *ldz, int *ns, int *nd, complex *sh, complex *v, int *ldv, int *nh, complex *t, int *ldt, int *nv, complex *wv, int *ldwv, complex *work, int *lwork);
extern void claqr4_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, complex *h, int *ldh, complex *w, int *iloz, int *ihiz, complex *z, int *ldz, complex *work, int *lwork, int *info);
extern void claqr5_(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, complex *s, complex *h, int *ldh, int *iloz, int *ihiz, complex *z, int *ldz, complex *v, int *ldv, complex *u, int *ldu, int *nv, complex *wv, int *ldwv, int *nh, complex *wh, int *ldwh);
extern void claqsb_(char *uplo, int *n, int *kd, complex *ab, int *ldab, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void claqsp_(char *uplo, int *n, complex *ap, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void claqsy_(char *uplo, int *n, complex *a, int *lda, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void clar1v_(int *n, int *b1, int *bn, float *lambda, float *d, float *l, float *ld, float *lld, float *pivmin, float *gaptol, complex *z, int *wantnc, int *negcnt, float *ztz, float *mingma, int *r, int *isuppz, float *nrminv, float *resid, float *rqcorr, float *work);
extern void clar2v_(int *n, complex *x, complex *y, complex *z, int *incx, float *c, complex *s, int *incc);
extern void clarcm_(int *m, int *n, float *a, int *lda, complex *b, int *ldb, complex *c, int *ldc, float *rwork);
extern void clarfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, complex *v, int *ldv, complex *t, int *ldt, complex *c, int *ldc, complex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void clarf_(char *side, int *m, int *n, complex *v, int *incv, complex *tau, complex *c, int *ldc, complex *work, int side_len);
extern void clarfg_(int *n, complex *alpha, complex *x, int *incx, complex *tau);
extern void clarft_(char *direct, char *storev, int *n, int *k, complex *v, int *ldv, complex *tau, complex *t, int *ldt, int direct_len, int storev_len);
extern void clarfx_(char *side, int *m, int *n, complex *v, complex *tau, complex *c, int *ldc, complex *work, int side_len);
extern void clargv_(int *n, complex *x, int *incx, complex *y, int *incy, float *c, int *incc);
extern void clarnv_(int *idist, int *iseed, int *n, complex *x);
extern void clarrv_(int *n, float *vl, float *vu, float *d, float *l, float *pivmin, int *isplit, int *m, int *dol, int *dou, float *minrgp, float *rtol1, float *rtol2, float *w, float *werr, float *wgap, int *iblock, int *indexw, float *gers, complex *z, int *ldz, int *isuppz, float *work, int *iwork, int *info);
extern void clartg_(complex *f, complex *g, float *cs, complex *sn, complex *r);
extern void clartv_(int *n, complex *x, int *incx, complex *y, int *incy, float *c, complex *s, int *incc);
extern void clarzb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, complex *v, int *ldv, complex *t, int *ldt, complex *c, int *ldc, complex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void clarz_(char *side, int *m, int *n, int *l, complex *v, int *incv, complex *tau, complex *c, int *ldc, complex *work, int side_len);
extern void clarzt_(char *direct, char *storev, int *n, int *k, complex *v, int *ldv, complex *tau, complex *t, int *ldt, int direct_len, int storev_len);
extern void clascl_(char *type, int *kl, int *ku, float *cfrom, float *cto, int *m, int *n, complex *a, int *lda, int *info, int type_len);
extern void claset_(char *uplo, int *m, int *n, complex *alpha, complex *beta, complex *a, int *lda, int uplo_len);
extern void clasr_(char *side, char *pivot, char *direct, int *m, int *n, float *c, float *s, complex *a, int *lda, int side_len, int pivot_len, int direct_len);
extern void claswp_(int *n, complex *a, int *lda, int *k1, int *k2, int *ipiv, int *incx);
extern void clasyf_(char *uplo, int *n, int *nb, int *kb, complex *a, int *lda, int *ipiv, complex *w, int *ldw, int *info, int uplo_len);
extern void clatbs_(char *uplo, char *trans, char *diag, char *normin, int *n, int *kd, complex *ab, int *ldab, complex *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void clatdf_(int *ijob, int *n, complex *z, int *ldz, complex *rhs, float *rdsum, float *rdscal, int *ipiv, int *jpiv);
extern void clatps_(char *uplo, char *trans, char *diag, char *normin, int *n, complex *ap, complex *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void clatrd_(char *uplo, int *n, int *nb, complex *a, int *lda, float *e, complex *tau, complex *w, int *ldw, int uplo_len);
extern void clatrs_(char *uplo, char *trans, char *diag, char *normin, int *n, complex *a, int *lda, complex *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void clatrz_(int *m, int *n, int *l, complex *a, int *lda, complex *tau, complex *work);
extern void clatzm_(char *side, int *m, int *n, complex *v, int *incv, complex *tau, complex *c1, complex *c2, int *ldc, complex *work, int side_len);
extern void clauu2_(char *uplo, int *n, complex *a, int *lda, int *info, int uplo_len);
extern void clauum_(char *uplo, int *n, complex *a, int *lda, int *info, int uplo_len);
extern void cpbtf2_(char *uplo, int *n, int *kd, complex *ab, int *ldab, int *info, int uplo_len);
extern void cpotf2_(char *uplo, int *n, complex *a, int *lda, int *info, int uplo_len);
extern void cptts2_(int *iuplo, int *n, int *nrhs, float *d, complex *e, complex *b, int *ldb);
extern void crot_(int *n, complex *cx, int *incx, complex *cy, int *incy, float *c, complex *s);
extern void cspmv_(char *uplo, int *n, complex *alpha, complex *ap, complex *x, int *incx, complex *beta, complex *y, int *incy, int uplo_len);
extern void cspr_(char *uplo, int *n, complex *alpha, complex *x, int *incx, complex *ap, int uplo_len);
extern void csrscl_(int *n, float *sa, complex *sx, int *incx);
extern void csymv_(char *uplo, int *n, complex *alpha, complex *a, int *lda, complex *x, int *incx, complex *beta, complex *y, int *incy, int uplo_len);
extern void csyr_(char *uplo, int *n, complex *alpha, complex *x, int *incx, complex *a, int *lda, int uplo_len);
extern void csytf2_(char *uplo, int *n, complex *a, int *lda, int *ipiv, int *info, int uplo_len);
extern void ctgex2_(int *wantq, int *wantz, int *n, complex *a, int *lda, complex *b, int *ldb, complex *q, int *ldq, complex *z, int *ldz, int *j1, int *info);
extern void ctgsy2_(char *trans, int *ijob, int *m, int *n, complex *a, int *lda, complex *b, int *ldb, complex *c, int *ldc, complex *d, int *ldd, complex *e, int *lde, complex *f, int *ldf, float *scale, float *rdsum, float *rdscal, int *info, int trans_len);
extern void ctrti2_(char *uplo, char *diag, int *n, complex *a, int *lda, int *info, int uplo_len, int diag_len);
extern void cung2l_(int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cung2r_(int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cungl2_(int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cungr2_(int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *work, int *info);
extern void cunm2l_(char *side, char *trans, int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
extern void cunm2r_(char *side, char *trans, int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
extern void cunml2_(char *side, char *trans, int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
extern void cunmr2_(char *side, char *trans, int *m, int *n, int *k, complex *a, int *lda, complex *tau, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
extern void cunmr3_(char *side, char *trans, int *m, int *n, int *k, int *l, complex *a, int *lda, complex *tau, complex *c, int *ldc, complex *work, int *info, int side_len, int trans_len);
...
extern void dlacpy_(char *uplo, int *m, int *n, double *a, int *lda, double *b, int *ldb, int uplo_len);
...
extern void dlagtm_(char *trans, int *n, int *nrhs, double *alpha, double *dl, double *d, double *du, double *x, int *ldx, double *beta, double *b, int *ldb, int trans_len);
...
extern void dlalsd_(char *uplo, int *smlsiz, int *n, int *nrhs, double *d, double *e, double *b, int *ldb, double *rcond, int *rank, double *work, int *iwork, int *info, int uplo_len);
...
extern double dlangb_(char *norm, int *n, int *kl, int *ku, double *ab, int *ldab, double *work, int norm_len);
extern double dlange_(char *norm, int *m, int *n, double *a, int *lda, double *work, int norm_len);
extern double dlangt_(char *norm, int *n, double *dl, double *d, double *du, int norm_len);
extern double dlanhs_(char *norm, int *n, double *a, int *lda, double *work, int norm_len);
extern double dlansb_(char *norm, char *uplo, int *n, int *k, double *ab, int *ldab, double *work, int norm_len, int uplo_len);
extern double dlansp_(char *norm, char *uplo, int *n, double *ap, double *work, int norm_len, int uplo_len);
extern double dlanst_(char *norm, int *n, double *d, double *e, int norm_len);
extern double dlansy_(char *norm, char *uplo, int *n, double *a, int *lda, double *work, int norm_len, int uplo_len);
extern double dlantb_(char *norm, char *uplo, char *diag, int *n, int *k, double *ab, int *ldab, double *work, int norm_len, int uplo_len, int diag_len);
extern double dlantp_(char *norm, char *uplo, char *diag, int *n, double *ap, double *work, int norm_len, int uplo_len, int diag_len);
extern double dlantr_(char *norm, char *uplo, char *diag, int *m, int *n, double *a, int *lda, double *work, int norm_len, int uplo_len, int diag_len);
...
extern void dlaqgb_(int *m, int *n, int *kl, int *ku, double *ab, int *ldab, double *r, double *c, double *rowcnd, double *colcnd, double *amax, char *equed, int equed_len);
extern void dlaqge_(int *m, int *n, double *a, int *lda, double *r, double *c, double *rowcnd, double *colcnd, double *amax, char *equed, int equed_len);
...
extern void dlaqsb_(char *uplo, int *n, int *kd, double *ab, int *ldab, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void dlaqsp_(char *uplo, int *n, double *ap, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void dlaqsy_(char *uplo, int *n, double *a, int *lda, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
...
extern void dlarfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, double *v, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void dlarf_(char *side, int *m, int *n, double *v, int *incv, double *tau, double *c, int *ldc, double *work, int side_len);
extern void dlarfg_(int *n, double *alpha, double *x, int *incx, double *tau);
extern void dlarfx_(char *side, int *m, int *n, double *v, double *tau, double *c, int *ldc, double *work, int side_len);
...
extern void dlarrc_(char *jobt, int *n, double *vl, double *vu, double *d, double *e, double *pivmin, int *eigcnt, int *lcnt, int *rcnt, int *info, int jobt_len);
extern void dlarrd_(char *range, char *order, int *n, double *vl, double *vu, int *il, int *iu, double *gers, double *reltol, double *d, double *e, double *e2, double *pivmin, int *nsplit, int *isplit, int *m, double *w, double *werr, double *wl, double *wu, int *iblock, int *indexw, double *work, int *iwork, int *info, int range_len, int order_len);
extern void dlarre_(char *range, int *n, double *vl, double *vu, int *il, int *iu, double *d, double *e, double *e2, double *rtol1, double *rtol2, double *spltol, int *nsplit, int *isplit, int *m, double *w, double *werr, double *wgap, int *iblock, int *indexw, double *gers, double *pivmin, double *work, int *iwork, int *info, int range_len);
...
extern void dlarzb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, double *v, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void dlarz_(char *side, int *m, int *n, int *l, double *v, int *incv, double *tau, double *c, int *ldc, double *work, int side_len);
extern void dlarzt_(char *direct, char *storev, int *n, int *k, double *v, int *ldv, double *tau, double *t, int *ldt, int direct_len, int storev_len);
extern void dlas2_(double *f, double *g, double *h, double *ssmin, double *ssmax);
extern void dlascl_(char *type, int *kl, int *ku, double *cfrom, double *cto, int *m, int *n, double *a, int *lda, int *info, int type_len);
...
extern void dlasdq_(char *uplo, int *sqre, int *n, int *ncvt, int *nru, int *ncc, double *d, double *e, double *vt, int *ldvt, double *u, int *ldu, double *c, int *ldc, double *work, int *info, int uplo_len);
extern void dlasdt_(int *n, int *lvl, int *nd, int *inode, int *ndiml, int *ndimr, int *msub);
extern void dlaset_(char *uplo, int *m, int *n, double *alpha, double *beta, double *a, int *lda, int uplo_len);
...
extern void dlasr_(char *side, char *pivot, char *direct, int *m, int *n, double *c, double *s, double *a, int *lda, int side_len, int pivot_len, int direct_len);
...
extern void dlasyf_(char *uplo, int *n, int *nb, int *kb, double *a, int *lda, int *ipiv, double *w, int *ldw, int *info, int uplo_len);
extern void dlatbs_(char *uplo, char *trans, char *diag, char *normin, int *n, int *kd, double *ab, int *ldab, double *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void dlatdf_(int *ijob, int *n, double *z, int *ldz, double *rhs, double *rdsum, double *rdscal, int *ipiv, int *jpiv);
extern void dlatps_(char *uplo, char *trans, char *diag, char *normin, int *n, double *ap, double *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void dlatrd_(char *uplo, int *n, int *nb, double *a, int *lda, double *e, double *tau, double *w, int *ldw, int uplo_len);
extern void dlatrs_(char *uplo, char *trans, char *diag, char *normin, int *n, double *a, int *lda, double *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void dlatrz_(int *m, int *n, int *l, double *a, int *lda, double *tau, double *work);
extern void dlatzm_(char *side, int *m, int *n, double *v, int *incv, double *tau, double *c1, double *c2, int *ldc, double *work, int side_len);
extern void dlauu2_(char *uplo, int *n, double *a, int *lda, int *info, int uplo_len);
extern void dlauum_(char *uplo, int *n, double *a, int *lda, int *info, int uplo_len);
...
extern void dorm2l_(char *side, char *trans, int *m, int *n, int *k, double *a, int *lda, double *tau, double *c, int *ldc, double *work, int *info, int side_len, int trans_len);
extern void dorm2r_(char *side, char *trans, int *m, int *n, int *k, double *a, int *lda, double *tau, double *c, int *ldc, double *work, int *info, int side_len, int trans_len);
extern void dorml2_(char *side, char *trans, int *m, int *n, int *k, double *a, int *lda, double *tau, double *c, int *ldc, double *work, int *info, int side_len, int trans_len);
extern void dormr2_(char *side, char *trans, int *m, int *n, int *k, double *a, int *lda, double *tau, double *c, int *ldc, double *work, int *info, int side_len, int trans_len);
extern void dpbtf2_(char *uplo, int *n, int *kd, double *ab, int *ldab, int *info, int uplo_len);
extern void dpotf2_(char *uplo, int *n, double *a, int *lda, int *info, int uplo_len);
...
extern void dsygs2_(int *itype, char *uplo, int *n, double *a, int *lda, double *b, int *ldb, int *info, int uplo_len);
extern void dsytd2_(char *uplo, int *n, double *a, int *lda, double *d, double *e, double *tau, int *info, int uplo_len);
extern void dsytf2_(char *uplo, int *n, double *a, int *lda, int *ipiv, int *info, int uplo_len);
...
extern void dtgsy2_(char *trans, int *ijob, int *m, int *n, double *a, int *lda, double *b, int *ldb, double *c, int *ldc, double *d, int *ldd, double *e, int *lde, double *f, int *ldf, double *scale, double *rdsum, double *rdscal, int *iwork, int *pq, int *info, int trans_len);
extern void dtrti2_(char *uplo, char *diag, int *n, double *a, int *lda, int *info, int uplo_len, int diag_len);
extern double dzsum1_(int *n, doublecomplex *cx, int *incx);
extern int icmax1_(int *n, complex *cx, int *incx);
extern int ieeeck_(int *ispec, float *zero, float *one);
extern int iparmq_(int *ispec, char *name, char *opts, int *n, int *ilo, int *ihi, int *lwork, int name_len, int opts_len);
extern int izmax1_(int *n, doublecomplex *cx, int *incx);
extern int lsamen_(int *n, char *ca, char *cb, int ca_len, int cb_len);
extern float scsum1_(int *n, complex *cx, int *incx);
...
extern void slacpy_(char *uplo, int *m, int *n, float *a, int *lda, float *b, int *ldb, int uplo_len);
...
extern void slagtm_(char *trans, int *n, int *nrhs, float *alpha, float *dl, float *d, float *du, float *x, int *ldx, float *beta, float *b, int *ldb, int trans_len);
...
extern void slalsd_(char *uplo, int *smlsiz, int *n, int *nrhs, float *d, float *e, float *b, int *ldb, float *rcond, int *rank, float *work, int *iwork, int *info, int uplo_len);
...
extern float slangb_(char *norm, int *n, int *kl, int *ku, float *ab, int *ldab, float *work, int norm_len);
extern float slange_(char *norm, int *m, int *n, float *a, int *lda, float *work, int norm_len);
extern float slangt_(char *norm, int *n, float *dl, float *d, float *du, int norm_len);
extern float slanhs_(char *norm, int *n, float *a, int *lda, float *work, int norm_len);
extern float slansb_(char *norm, char *uplo, int *n, int *k, float *ab, int *ldab, float *work, int norm_len, int uplo_len);
extern float slansp_(char *norm, char *uplo, int *n, float *ap, float *work, int norm_len, int uplo_len);
extern float slanst_(char *norm, int *n, float *d, float *e, int norm_len);
extern float slansy_(char *norm, char *uplo, int *n, float *a, int *lda, float *work, int norm_len, int uplo_len);
extern float slantb_(char *norm, char *uplo, char *diag, int *n, int *k, float *ab, int *ldab, float *work, int norm_len, int uplo_len, int diag_len);
extern float slantp_(char *norm, char *uplo, char *diag, int *n, float *ap, float *work, int norm_len, int uplo_len, int diag_len);
extern float slantr_(char *norm, char *uplo, char *diag, int *m, int *n, float *a, int *lda, float *work, int norm_len, int uplo_len, int diag_len);
...
extern void slaqgb_(int *m, int *n, int *kl, int *ku, float *ab, int *ldab, float *r, float *c, float *rowcnd, float *colcnd, float *amax, char *equed, int equed_len);
extern void slaqge_(int *m, int *n, float *a, int *lda, float *r, float *c, float *rowcnd, float *colcnd, float *amax, char *equed, int equed_len);
...
extern void slaqsb_(char *uplo, int *n, int *kd, float *ab, int *ldab, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void slaqsp_(char *uplo, int *n, float *ap, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
extern void slaqsy_(char *uplo, int *n, float *a, int *lda, float *s, float *scond, float *amax, char *equed, int uplo_len, int equed_len);
...
extern void slarfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, float *v, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void slarf_(char *side, int *m, int *n, float *v, int *incv, float *tau, float *c, int *ldc, float *work, int side_len);
extern void slarfg_(int *n, float *alpha, float *x, int *incx, float *tau);
extern void slarfx_(char *side, int *m, int *n, float *v, float *tau, float *c, int *ldc, float *work, int side_len);
...
extern void slarrc_(char *jobt, int *n, float *vl, float *vu, float *d, float *e, float *pivmin, int *eigcnt, int *lcnt, int *rcnt, int *info, int jobt_len);
extern void slarrd_(char *range, char *order, int *n, float *vl, float *vu, int *il, int *iu, float *gers, float *reltol, float *d, float *e, float *e2, float *pivmin, int *nsplit, int *isplit, int *m, float *w, float *werr, float *wl, float *wu, int *iblock, int *indexw, float *work, int *iwork, int *info, int range_len, int order_len);
extern void slarre_(char *range, int *n, float *vl, float *vu, int *il, int *iu, float *d, float *e, float *e2, float *rtol1, float *rtol2, float *spltol, int *nsplit, int *isplit, int *m, float *w, float *werr, float *wgap, int *iblock, int *indexw, float *gers, float *pivmin, float *work, int *iwork, int *info, int range_len);
...
extern void slarzb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, float *v, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void slarz_(char *side, int *m, int *n, int *l, float *v, int *incv, float *tau, float *c, int *ldc, float *work, int side_len);
extern void slarzt_(char *direct, char *storev, int *n, int *k, float *v, int *ldv, float *tau, float *t, int *ldt, int direct_len, int storev_len);
extern void slas2_(float *f, float *g, float *h, float *ssmin, float *ssmax);
extern void slascl_(char *type, int *kl, int *ku, float *cfrom, float *cto, int *m, int *n, float *a, int *lda, int *info, int type_len);
...
extern void slasdq_(char *uplo, int *sqre, int *n, int *ncvt, int *nru, int *ncc, float *d, float *e, float *vt, int *ldvt, float *u, int *ldu, float *c, int *ldc, float *work, int *info, int uplo_len);
extern void slasdt_(int *n, int *lvl, int *nd, int *inode, int *ndiml, int *ndimr, int *msub);
extern void slaset_(char *uplo, int *m, int *n, float *alpha, float *beta, float *a, int *lda, int uplo_len);
...
extern void slasr_(char *side, char *pivot, char *direct, int *m, int *n, float *c, float *s, float *a, int *lda, int side_len, int pivot_len, int direct_len);
...
extern void slasyf_(char *uplo, int *n, int *nb, int *kb, float *a, int *lda, int *ipiv, float *w, int *ldw, int *info, int uplo_len);
extern void slatbs_(char *uplo, char *trans, char *diag, char *normin, int *n, int *kd, float *ab, int *ldab, float *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void slatdf_(int *ijob, int *n, float *z, int *ldz, float *rhs, float *rdsum, float *rdscal, int *ipiv, int *jpiv);
extern void slatps_(char *uplo, char *trans, char *diag, char *normin, int *n, float *ap, float *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void slatrd_(char *uplo, int *n, int *nb, float *a, int *lda, float *e, float *tau, float *w, int *ldw, int uplo_len);
extern void slatrs_(char *uplo, char *trans, char *diag, char *normin, int *n, float *a, int *lda, float *x, float *scale, float *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void slatrz_(int *m, int *n, int *l, float *a, int *lda, float *tau, float *work);
extern void slatzm_(char *side, int *m, int *n, float *v, int *incv, float *tau, float *c1, float *c2, int *ldc, float *work, int side_len);
extern void slauu2_(char *uplo, int *n, float *a, int *lda, int *info, int uplo_len);
extern void slauum_(char *uplo, int *n, float *a, int *lda, int *info, int uplo_len);
...
extern void sorm2l_(char *side, char *trans, int *m, int *n, int *k, float *a, int *lda, float *tau, float *c, int *ldc, float *work, int *info, int side_len, int trans_len);
extern void sorm2r_(char *side, char *trans, int *m, int *n, int *k, float *a, int *lda, float *tau, float *c, int *ldc, float *work, int *info, int side_len, int trans_len);
extern void sorml2_(char *side, char *trans, int *m, int *n, int *k, float *a, int *lda, float *tau, float *c, int *ldc, float *work, int *info, int side_len, int trans_len);
extern void sormr2_(char *side, char *trans, int *m, int *n, int *k, float *a, int *lda, float *tau, float *c, int *ldc, float *work, int *info, int side_len, int trans_len);
extern void spbtf2_(char *uplo, int *n, int *kd, float *ab, int *ldab, int *info, int uplo_len);
extern void spotf2_(char *uplo, int *n, float *a, int *lda, int *info, int uplo_len);
extern void sptts2_(int *n, int *nrhs, float *d, float *e, float *b, int *ldb);
extern void srscl_(int *n, float *sa, float *sx, int *incx);
extern void ssygs2_(int *itype, char *uplo, int *n, float *a, int *lda, float *b, int *ldb, int *info, int uplo_len);
extern void ssytd2_(char *uplo, int *n, float *a, int *lda, float *d, float *e, float *tau, int *info, int uplo_len);
extern void ssytf2_(char *uplo, int *n, float *a, int *lda, int *ipiv, int *info, int uplo_len);
...
extern void stgsy2_(char *trans, int *ijob, int *m, int *n, float *a, int *lda, float *b, int *ldb, float *c, int *ldc, float *d, int *ldd, float *e, int *lde, float *f, int *ldf, float *scale, float *rdsum, float *rdscal, int *iwork, int *pq, int *info, int trans_len);
extern void strti2_(char *uplo, char *diag, int *n, float *a, int *lda, int *info, int uplo_len, int diag_len);
extern void zdrscl_(int *n, double *sa, doublecomplex *sx, int *incx);
extern void zgbtf2_(int *m, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, int *ipiv, int *info);
extern void zgebd2_(int *m, int *n, doublecomplex *a, int *lda, double *d, double *e, doublecomplex *tauq, doublecomplex *taup, doublecomplex *work, int *info);
extern void zgehd2_(int *n, int *ilo, int *ihi, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgelq2_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgeql2_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgeqr2_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgerq2_(int *m, int *n, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zgesc2_(int *n, doublecomplex *a, int *lda, doublecomplex *rhs, int *ipiv, int *jpiv, double *scale);
extern void zgetc2_(int *n, doublecomplex *a, int *lda, int *ipiv, int *jpiv, int *info);
extern void zgetf2_(int *m, int *n, doublecomplex *a, int *lda, int *ipiv, int *info);
extern void zgtts2_(int *itrans, int *n, int *nrhs, doublecomplex *dl, doublecomplex *d, doublecomplex *du, doublecomplex *du2, int *ipiv, doublecomplex *b, int *ldb);
extern void zhegs2_(int *itype, char *uplo, int *n, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, int *info, int uplo_len);
extern void zhetd2_(char *uplo, int *n, doublecomplex *a, int *lda, double *d, double *e, doublecomplex *tau, int *info, int uplo_len);
extern void zhetf2_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, int *info, int uplo_len);
extern void zlabrd_(int *m, int *n, int *nb, doublecomplex *a, int *lda, double *d, double *e, doublecomplex *tauq, doublecomplex *taup, doublecomplex *x, int *ldx, doublecomplex *y, int *ldy);
extern void zlacgv_(int *n, doublecomplex *x, int *incx);
extern void zlacn2_(int *n, doublecomplex *v, doublecomplex *x, double *est, int *kase, int *isave);
extern void zlacon_(int *n, doublecomplex *v, doublecomplex *x, double *est, int *kase);
extern void zlacp2_(char *uplo, int *m, int *n, double *a, int *lda, doublecomplex *b, int *ldb, int uplo_len);
extern void zlacpy_(char *uplo, int *m, int *n, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, int uplo_len);
extern void zlacrm_(int *m, int *n, doublecomplex *a, int *lda, double *b, int *ldb, doublecomplex *c, int *ldc, double *rwork);
extern void zlacrt_(int *n, doublecomplex *cx, int *incx, doublecomplex *cy, int *incy, doublecomplex *c, doublecomplex *s);
extern doublecomplex zladiv_(doublecomplex *ret_val, doublecomplex *x, doublecomplex *y);

extern void zlaed0_(int *qsiz, int *n, double *d, double *e, doublecomplex *q, int *ldq, doublecomplex *qstore, int *ldqs, double *rwork, int *iwork, int *info);
extern void zlaed7_(int *n, int *cutpnt, int *qsiz, int *tlvls, int *curlvl, int *curpbm, double *d, doublecomplex *q, int *ldq, double *rho, int *indxq, double *qstore, int *qptr, int *prmptr, int *perm, int *givptr, int *givcol, double *givnum, doublecomplex *work, double *rwork, int *iwork, int *info);
extern void zlaed8_(int *k, int *n, int *qsiz, doublecomplex *q, int *ldq, double *d, double *rho, int *cutpnt, double *z, double *dlamda, doublecomplex *q2, int *ldq2, double *w, int *indxp, int *indx, int *indxq, int *perm, int *givptr, int *givcol, double *givnum, int *info);
extern void zlaein_(int *rightv, int *noinit, int *n, doublecomplex *h, int *ldh, doublecomplex *w, doublecomplex *v, doublecomplex *b, int *ldb, double *rwork, double *eps3, double *smlnum, int *info);
...
extern void zlag2c_(int *m, int *n, doublecomplex *a, int *lda, complex *sa, int *ldsa, int *info);
extern void zlags2_(int *upper, double *a1, doublecomplex * a2, double *a3, double *b1, doublecomplex *b2, double *b3, double *csu, doublecomplex *snu, double *csv, doublecomplex * snv, double *csq, doublecomplex *snq);
extern void zlagtm_(char *trans, int *n, int *nrhs, double *alpha, doublecomplex *dl, doublecomplex *d, doublecomplex *du, doublecomplex *x, int *ldx, double *beta, doublecomplex *b, int *ldb, int trans_len);
extern void zlahef_(char *uplo, int *n, int *nb, int *kb, doublecomplex *a, int *lda, int *ipiv, doublecomplex *w, int *ldw, int *info, int uplo_len);
extern void zlahqr_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, doublecomplex *h, int *ldh, doublecomplex *w, int *iloz, int *ihiz, doublecomplex *z, int *ldz, int *info);
extern void zlahr2_(int *n, int *k, int *nb, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *t, int *ldt, doublecomplex *y, int *ldy);
extern void zlahrd_(int *n, int *k, int *nb, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *t, int *ldt, doublecomplex *y, int *ldy);
extern void zlaic1_(int *job, int *j, doublecomplex *x, double *sest, doublecomplex *w, doublecomplex *gamma, double *sestpr, doublecomplex *s, doublecomplex *c);
extern void zlals0_(int *icompq, int *nl, int *nr, int *sqre, int *nrhs, doublecomplex *b, int *ldb, doublecomplex *bx, int *ldbx, int *perm, int *givptr, int *givcol, int *ldgcol, double *givnum, int *ldgnum, double *poles, double *difl, double *difr, double *z, int *k, double *c, double *s, double *rwork, int *info);
extern void zlalsa_(int *icompq, int *smlsiz, int *n, int *nrhs, doublecomplex *b, int *ldb, doublecomplex *bx, int *ldbx, double *u, int *ldu, double *vt, int *k, double *difl, double *difr, double *z, double *poles, int *givptr, int *givcol, int *ldgcol, int *perm, double *givnum, double *c, double *s, double *rwork, int *iwork, int *info);
extern void zlalsd_(char *uplo, int *smlsiz, int *n, int *nrhs, double *d, double *e, doublecomplex *b, int *ldb, double *rcond, int *rank, doublecomplex *work, double *rwork, int *iwork, int *info, int uplo_len);
extern double zlangb_(char *norm, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, double *work, int norm_len);
extern double zlange_(char *norm, int *m, int *n, doublecomplex *a, int *lda, double *work, int norm_len);
extern double zlangt_(char *norm, int *n, doublecomplex *dl, doublecomplex *d, doublecomplex *du, int norm_len);
extern double zlanhb_(char *norm, char *uplo, int *n, int *k, doublecomplex *ab, int *ldab, double *work, int norm_len, int uplo_len);
extern double zlanhe_(char *norm, char *uplo, int *n, doublecomplex *a, int *lda, double *work, int norm_len, int uplo_len);
extern double zlanhp_(char *norm, char *uplo, int *n, doublecomplex *ap, double *work, int norm_len, int uplo_len);
extern double zlanhs_(char *norm, int *n, doublecomplex *a, int *lda, double *work, int norm_len);
extern double zlanht_(char *norm, int *n, double *d, doublecomplex *e, int norm_len);
extern double zlansb_(char *norm, char *uplo, int *n, int *k, doublecomplex *ab, int *ldab, double *work, int norm_len, int uplo_len);
extern double zlansp_(char *norm, char *uplo, int *n, doublecomplex *ap, double *work, int norm_len, int uplo_len);
extern double zlansy_(char *norm, char *uplo, int *n, doublecomplex *a, int *lda, double *work, int norm_len, int uplo_len);
extern double zlantb_(char *norm, char *uplo, char *diag, int *n, int *k, doublecomplex *ab, int *ldab, double *work, int norm_len, int uplo_len, int diag_len);
extern double zlantp_(char *norm, char *uplo, char *diag, int *n, doublecomplex *ap, double *work, int norm_len, int uplo_len, int diag_len);
extern double zlantr_(char *norm, char *uplo, char *diag, int *m, int *n, doublecomplex *a, int *lda, double *work, int norm_len, int uplo_len, int diag_len);
extern void zlapll_(int *n, doublecomplex *x, int *incx, doublecomplex *y, int *incy, double *ssmin);
extern void zlapmt_(int *forwrd, int *m, int *n, doublecomplex *x, int *ldx, int *k);
extern void zlaqgb_(int *m, int *n, int *kl, int *ku, doublecomplex *ab, int *ldab, double *r, double *c, double *rowcnd, double *colcnd, double *amax, char *equed, int equed_len);
extern void zlaqge_(int *m, int *n, doublecomplex *a, int *lda, double *r, double *c, double *rowcnd, double *colcnd, double *amax, char *equed, int equed_len);
extern void zlaqhb_(char *uplo, int *n, int *kd, doublecomplex *ab, int *ldab, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlaqhe_(char *uplo, int *n, doublecomplex *a, int *lda, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlaqhp_(char *uplo, int *n, doublecomplex *ap, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlaqp2_(int *m, int *n, int *offset, doublecomplex *a, int *lda, int *jpvt, doublecomplex *tau, double *vn1, double *vn2, doublecomplex *work);
extern void zlaqps_(int *m, int *n, int *offset, int *nb, int *kb, doublecomplex *a, int *lda, int *jpvt, doublecomplex *tau, double *vn1, double *vn2, doublecomplex *auxv, doublecomplex *f, int *ldf);
extern void zlaqr0_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, doublecomplex *h, int *ldh, doublecomplex *w, int *iloz, int *ihiz, doublecomplex *z, int *ldz, doublecomplex *work, int *lwork, int *info);
extern void zlaqr1_(int *n, doublecomplex *h, int*ldh, doublecomplex *s1, doublecomplex *s2, doublecomplex *v);
extern void zlaqr2_(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, doublecomplex *h, int *ldh, int *iloz, int *ihiz, doublecomplex *z, int *ldz, int *ns, int *nd, doublecomplex *sh, doublecomplex *v, int *ldv, int *nh, doublecomplex *t, int *ldt, int *nv, doublecomplex *wv, int *ldwv, doublecomplex *work, int *lwork);
extern void zlaqr3_(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, doublecomplex *h, int *ldh, int *iloz, int *ihiz, doublecomplex *z, int *ldz, int *ns, int *nd, doublecomplex *sh, doublecomplex *v, int *ldv, int *nh, doublecomplex *t, int *ldt, int *nv, doublecomplex *wv, int *ldwv, doublecomplex *work, int *lwork);
extern void zlaqr4_(int *wantt, int *wantz, int *n, int *ilo, int *ihi, doublecomplex *h, int *ldh, doublecomplex *w, int *iloz, int *ihiz, doublecomplex *z, int *ldz, doublecomplex *work, int *lwork, int *info);
extern void zlaqr5_(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, doublecomplex *s, doublecomplex *h, int *ldh, int *iloz, int *ihiz, doublecomplex *z, int *ldz, doublecomplex *v, int *ldv, doublecomplex *u, int *ldu, int *nv, doublecomplex *wv, int *ldwv, int *nh, doublecomplex *wh, int *ldwh);
extern void zlaqsb_(char *uplo, int *n, int *kd, doublecomplex *ab, int *ldab, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlaqsp_(char *uplo, int *n, doublecomplex *ap, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlaqsy_(char *uplo, int *n, doublecomplex *a, int *lda, double *s, double *scond, double *amax, char *equed, int uplo_len, int equed_len);
extern void zlar1v_(int *n, int *b1, int *bn, double *lambda, double *d, double *l, double *ld, double *lld, double *pivmin, double *gaptol, doublecomplex *z, int *wantnc, int *negcnt, double *ztz, double *mingma, int *r, int *isuppz, double *nrminv, double *resid, double *rqcorr, double *work);
extern void zlar2v_(int *n, doublecomplex *x, doublecomplex *y, doublecomplex *z, int *incx, double *c, doublecomplex *s, int *incc);
extern void zlarcm_(int *m, int *n, double *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *c, int *ldc, double *rwork);
extern void zlarfb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, doublecomplex *v, int *ldv, doublecomplex *t, int *ldt, doublecomplex *c, int *ldc, doublecomplex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void zlarf_(char *side, int *m, int *n, doublecomplex *v, int *incv, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int side_len);
extern void zlarfg_(int *n, doublecomplex *alpha, doublecomplex *x, int *incx, doublecomplex *tau);
extern void zlarft_(char *direct, char *storev, int *n, int *k, doublecomplex *v, int *ldv, doublecomplex *tau, doublecomplex *t, int *ldt, int direct_len, int storev_len);
extern void zlarfx_(char *side, int *m, int *n, doublecomplex *v, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int side_len);
extern void zlargv_(int *n, doublecomplex *x, int *incx, doublecomplex *y, int *incy, double *c, int *incc);
extern void zlarnv_(int *idist, int *iseed, int *n, doublecomplex *x);
extern void zlarrv_(int *n, double *vl, double *vu, double *d, double *l, double *pivmin, int *isplit, int *m, int *dol, int *dou, double *minrgp, double *rtol1, double *rtol2, double *w, double *werr, double *wgap, int *iblock, int *indexw, double *gers, doublecomplex *z, int *ldz, int *isuppz, double *work, int *iwork, int *info);
extern void zlartg_(doublecomplex *f, doublecomplex *g, double *cs, doublecomplex *sn, doublecomplex *r);
extern void zlartv_(int *n, doublecomplex *x, int *incx, doublecomplex *y, int *incy, double *c, doublecomplex *s, int *incc);
extern void zlarzb_(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, doublecomplex *v, int *ldv, doublecomplex *t, int *ldt, doublecomplex *c, int *ldc, doublecomplex *work, int *ldwork, int side_len, int trans_len, int direct_len, int storev_len);
extern void zlarz_(char *side, int *m, int *n, int *l, doublecomplex *v, int *incv, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int side_len);
extern void zlarzt_(char *direct, char *storev, int *n, int *k, doublecomplex *v, int *ldv, doublecomplex *tau, doublecomplex *t, int *ldt, int direct_len, int storev_len);
extern void zlascl_(char *type, int *kl, int *ku, double *cfrom, double *cto, int *m, int *n, doublecomplex *a, int *lda, int *info, int type_len);
extern void zlaset_(char *uplo, int *m, int *n, doublecomplex *alpha, doublecomplex *beta, doublecomplex *a, int *lda, int uplo_len);
extern void zlasr_(char *side, char *pivot, char *direct, int *m, int *n, double *c, double *s, doublecomplex *a, int *lda, int side_len, int pivot_len, int direct_len);
extern void zlaswp_(int *n, doublecomplex *a, int *lda, int *k1, int *k2, int *ipiv, int *incx);
extern void zlasyf_(char *uplo, int *n, int *nb, int *kb, doublecomplex *a, int *lda, int *ipiv, doublecomplex *w, int *ldw, int *info, int uplo_len);
extern void zlatbs_(char *uplo, char *trans, char *diag, char *normin, int *n, int *kd, doublecomplex *ab, int *ldab, doublecomplex *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void zlatdf_(int *ijob, int *n, doublecomplex *z, int *ldz, doublecomplex *rhs, double *rdsum, double *rdscal, int *ipiv, int *jpiv);
extern void zlatps_(char *uplo, char *trans, char *diag, char *normin, int *n, doublecomplex *ap, doublecomplex *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void zlatrd_(char *uplo, int *n, int *nb, doublecomplex *a, int *lda, double *e, doublecomplex *tau, doublecomplex *w, int *ldw, int uplo_len);
extern void zlatrs_(char *uplo, char *trans, char *diag, char *normin, int *n, doublecomplex *a, int *lda, doublecomplex *x, double *scale, double *cnorm, int *info, int uplo_len, int trans_len, int diag_len, int normin_len);
extern void zlatrz_(int *m, int *n, int *l, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work);
extern void zlatzm_(char *side, int *m, int *n, doublecomplex *v, int *incv, doublecomplex *tau, doublecomplex *c1, doublecomplex *c2, int *ldc, doublecomplex *work, int side_len);
extern void zlauu2_(char *uplo, int *n, doublecomplex *a, int *lda, int *info, int uplo_len);
extern void zlauum_(char *uplo, int *n, doublecomplex *a, int *lda, int *info, int uplo_len);
extern void zpbtf2_(char *uplo, int *n, int *kd, doublecomplex *ab, int *ldab, int *info, int uplo_len);
extern void zpotf2_(char *uplo, int *n, doublecomplex *a, int *lda, int *info, int uplo_len);
extern void zptts2_(int *iuplo, int *n, int *nrhs, double *d, doublecomplex *e, doublecomplex *b, int *ldb);
extern void zrot_(int *n, doublecomplex *cx, int *incx, doublecomplex *cy, int *incy, double *c, doublecomplex *s);
extern void zspmv_(char *uplo, int *n, doublecomplex *alpha, doublecomplex *ap, doublecomplex *x, int *incx, doublecomplex *beta, doublecomplex *y, int *incy, int uplo_len);
extern void zspr_(char *uplo, int *n, doublecomplex *alpha, doublecomplex *x, int *incx, doublecomplex *ap, int uplo_len);
extern void zsymv_(char *uplo, int *n, doublecomplex *alpha, doublecomplex *a, int *lda, doublecomplex *x, int *incx, doublecomplex *beta, doublecomplex *y, int *incy, int uplo_len);
extern void zsyr_(char *uplo, int *n, doublecomplex *alpha, doublecomplex *x, int *incx, doublecomplex *a, int *lda, int uplo_len);
extern void zsytf2_(char *uplo, int *n, doublecomplex *a, int *lda, int *ipiv, int *info, int uplo_len);
extern void ztgex2_(int *wantq, int *wantz, int *n, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *q, int *ldq, doublecomplex *z, int *ldz, int *j1, int *info);
extern void ztgsy2_(char *trans, int *ijob, int *m, int *n, doublecomplex *a, int *lda, doublecomplex *b, int *ldb, doublecomplex *c, int *ldc, doublecomplex *d, int *ldd, doublecomplex *e, int *lde, doublecomplex *f, int *ldf, double *scale, double *rdsum, double *rdscal, int *info, int trans_len);
extern void ztrti2_(char *uplo, char *diag, int *n, doublecomplex *a, int *lda, int *info, int uplo_len, int diag_len);
extern void zung2l_(int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zung2r_(int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zungl2_(int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zungr2_(int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *work, int *info);
extern void zunm2l_(char *side, char *trans, int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
extern void zunm2r_(char *side, char *trans, int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
extern void zunml2_(char *side, char *trans, int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
extern void zunmr2_(char *side, char *trans, int *m, int *n, int *k, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
extern void zunmr3_(char *side, char *trans, int *m, int *n, int *k, int *l, doublecomplex *a, int *lda, doublecomplex *tau, doublecomplex *c, int *ldc, doublecomplex *work, int *info, int side_len, int trans_len);
...
extern void csfft1d_(int *mode, int *n, complex *x, float *y, float *comm, int *info);
extern void csfft1m_(int *mode, int *m, int *n, complex *x, float *y, float *comm, int *info);
extern void csfft2d_(int *mode, int *m, int *n, complex *x, float *y, float *comm, int *info);
extern void csfft3d_(int *mode, int *l, int *m, int *n, complex *x, float *y, float *comm, int *info);
...
extern void dzfft1d_(int *mode, int *n, double *x, doublecomplex *y, double *comm, int *info);
extern void dzfft1m_(int *mode, int *m, int *n, double *x, doublecomplex *y, double *comm, int *info);
extern void dzfft2d_(int *mode, int *m, int *n, double *x, doublecomplex *y, double *comm, int *info);
extern void dzfft3d_(int *mode, int *l, int *m, int *n, double *x, doublecomplex *y, double *comm, int *info);
...
extern void scfft1d_(int *mode, int *n, float *x, complex *y, float *comm, int *info);
extern void scfft1m_(int *mode, int *m, int *n, float *x, complex *y, float *comm, int *info);
extern void scfft2d_(int *mode, int *m, int *n, float *x, complex *y, float *comm, int *info);
extern void scfft3d_(int *mode, int *l, int *m, int *n, float *x, complex *y, float *comm, int *info);
...
extern void zdfft1d_(int *mode, int *n, doublecomplex *x, double *y, double *comm, int *info);
extern void zdfft1m_(int *mode, int *m, int *n, doublecomplex *x, double *y, double *comm, int *info);
extern void zdfft2d_(int *mode, int *m, int *n, doublecomplex *x, double *y, double *comm, int *info);
extern void zdfft3d_(int *mode, int *l, int *m, int *n, doublecomplex *x, double *y, double *comm, int *info);
